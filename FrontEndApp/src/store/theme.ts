...
export const useThemeStore = defineStore('useThemeStore', () => {
    ...
    const themeOverrides = ref<any>({
        ...
        DatePicker: {
            panelColor: 'var(--theme-bg-elevated)',
            panelTextColor: 'var(--theme-text)',
            panelBoxShadow: '0 12px 30px rgba(0, 0, 0, 0.28), 0 0 0 1px var(--theme-border)',
            panelHeaderDividerColor: 'var(--theme-border)',
            panelActionDividerColor: 'var(--theme-border)',
            calendarTitleTextColor: 'var(--theme-text)',
            calendarTitleColorHover: 'var(--theme-bg-soft)',
            calendarDaysTextColor: 'var(--theme-text-soft)',
            calendarDaysDividerColor: 'var(--theme-border)',
            calendarDividerColor: 'var(--theme-border)',
            itemTextColor: 'var(--theme-text)',
            itemTextColorDisabled: 'var(--theme-text-soft)',
            itemTextColorActive: 'var(--theme-bg-main)',
            itemTextColorCurrent: 'var(--primary-color)',
            itemColorIncluded: 'color-mix(in srgb, var(--primary-color) 16%, transparent)',
            itemColorHover: 'var(--theme-bg-soft)',
            itemColorDisabled: 'color-mix(in srgb, var(--theme-bg-soft) 55%, transparent)',
            itemColorActive: 'var(--primary-color)',
            arrowColor: 'var(--theme-text-soft)',
